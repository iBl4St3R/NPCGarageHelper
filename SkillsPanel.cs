...
namespace NPCGarageHelper
{
    internal class SkillsPanel
    {
        ...
        // Per category: 3 value labels + 3 buttons
        ...
        private void StylePanel()
        {
            ...
            S.BgColor(st, new Color(0.04f, 0.05f, 0.10f, 1.0f));
        ...
        private void AddCategorySection(NpcSkillData.Category cat, int idx)
        {
            ...
            // Success chance
            {
                ...
                var lbl = row.AddLabel("  Repair chance:", 200f, new Color(0.55f, 0.55f, 0.65f, 1f));
                lbl.SetFontSize(13);
                _lblSuccess[idx] = row.AddLabel("--", 160f, new Color(0.80f, 0.80f, 0.90f, 1f));
                _lblSuccess[idx].SetFontSize(13);
            ...
            {
                var row = _panel.AddRow(26f, 2f);
                var lbl = row.AddLabel("  Max. repair:", 200f, new Color(0.55f, 0.55f, 0.65f, 1f));
                lbl.SetFontSize(13);
            ...
            {
                var row = _panel.AddRow(26f, 2f);
                var lbl = row.AddLabel("  Min. repair:", 200f, new Color(0.55f, 0.55f, 0.65f, 1f));
                lbl.SetFontSize(13);
        ...
        public void Refresh()
        {
            _lblPoints?.SetText($"Available skill points: {NpcSkillData.AvailablePoints}");
            ...
            for (int i = 0; i < 6; i++)
            {
                ...
                _btnSuccess[i]?.SetText(sLvl == 0
                    ...
                    : canUpS
                        ? $"+ Lvl {sLvl + 1} (1pt)"
                        : sLvl >= NpcSkillData.MAX_SUCCESS_LVL ? "MAX" : "No points");
